...
class Alien(pygame.sprite.Sprite): #Create a class for aliens level 1-3
    def __init__(self, settings, screen, level=1):
        ...
        if level == 1:
            ...
            self.spritesize = (round(40*self.resizer), round(69*self.resizer))
             ...
             img_path = CRUISER_PATH
             self.speed = settings.cruiser_speed
             self.spritesize = (round(100*self.resizer), round(225*self.resizer))
    ...
    def update(self):
        ...
        elif self.level == 6: #cruisers are level 6. Their movement and bullets both are slower and larger.
            self.y += self.speed
            self.rect.y = int(self.y)
