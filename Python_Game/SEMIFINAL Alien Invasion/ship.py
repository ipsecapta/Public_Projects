...
class Ship(pygame.sprite.Sprite): #create a Ship class, that is a sub-class of the pygame Sprite class.
    def __init__(self, settings, screen, player_id, player_level=1, player_health=1, player_lives=3, score = 0, player_state = "alive"):
        super().__init__()
        ...
        self.rect.bottom = int(settings.screen_height * 0.9) # both players start toward the bottom of the screen vertically.
