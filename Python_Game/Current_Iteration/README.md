...
Arcade shooter. Passion project, initial codebase done by hand (check out other directories for work-in-progress snapshots)



&nbsp;	Secret wave built around cat memes. See password\_spoiler.txt (or hunt in the code) if you want to find the password for access to it. 

&nbsp;	Otherwise you have to beat the game on hard, with powerups on either normal or low.

&nbsp;	Many features left to add.
